...
bool (*World::CantBuild)(UWorld*, UObject*, FVector, FRotator, char, void*, char*) = decltype(World::CantBuild)(ImageBase + 0xF61000);
...
ENetMode World::GetNetMode(UWorld* World) 
{ 
...
void World::Patch()
{
	CreateHook(0x2B92880, GetNetMode);
}