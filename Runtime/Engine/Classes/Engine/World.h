...
{
public:
	static bool (*CantBuild)(UWorld*, UObject*, FVector, FRotator, char, void*, char*);
	...
	{
		static auto oSpawnActor = (AActor * (*)(UWorld * World, UClass * Class, FTransform const* UserTransformPtr, const FActorSpawnParameters & SpawnParameters))(InSDKUtils::GetImageBase() + 0x2811830);
	...
	static ENetMode GetNetMode(UWorld* World);
