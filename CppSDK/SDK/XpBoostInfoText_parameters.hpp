...
public:
	...
	TDelegate<void(const struct FFortPublicAccountInfo& NewInfo)> K2Node_CreateDelegate_OutputDelegate; // 0x0004(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(int32 BoostAmount)>            K2Node_CreateDelegate_OutputDelegate1;             // 0x0014(0x0010)(ZeroConstructor, NoDestructor)
...
// Function XpBoostInfoText.XpBoostInfoText_C.SetScrollWidget
// 0x0008 (0x0008 - 0x0000)
struct XpBoostInfoText_C_SetScrollWidget final
{
public:
