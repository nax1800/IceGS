...
public:
	...
	bool                                          CallFunc_GetTimeUntilCalendarEventEnd_bFoundEvent; // 0x01F1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1F2[0x6];                                      // 0x01F2(0x0006)(Fixing Size After Last Property [ Dumper-8 ])
	struct FTimespan                              CallFunc_GetTimeUntilCalendarEventEnd_OutTime;     // 0x01F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
