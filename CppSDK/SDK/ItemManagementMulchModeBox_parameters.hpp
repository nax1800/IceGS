...
public:
	...
	TDelegate<void(bool* bPassThrough)>           K2Node_CreateDelegate_OutputDelegate1;             // 0x003C(0x0010)(ZeroConstructor, NoDestructor)
...
struct ItemManagementMulchModeBox_C_SetScrollFocus final
{
public:
