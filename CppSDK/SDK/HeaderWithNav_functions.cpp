...
// Function HeaderWithNav.HeaderWithNav_C.SetupInventoryFilterButtons
// (Public, BlueprintCallable, BlueprintEvent)

void UHeaderWithNav_C::SetupInventoryFilterButtons()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HeaderWithNav_C", "SetupInventoryFilterButtons");
