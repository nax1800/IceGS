...
// Function BGA_Athena_BoomBox.BGA_Athena_BoomBox_C.BeatStarted
// (Net, NetMulticast, BlueprintCallable, BlueprintEvent)

void ABGA_Athena_BoomBox_C::BeatStarted()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BGA_Athena_BoomBox_C", "BeatStarted");
