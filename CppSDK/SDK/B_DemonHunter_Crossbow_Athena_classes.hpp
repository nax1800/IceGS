...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_B_DemonHunter_Crossbow_Athena_C;    // 0x0DD0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UParticleSystemComponent*               P_DemonHunter_Crossbow_FireTipFlare;               // 0x0DD8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
