...
void UXpBarXpText_C::SetDetailsVisibility(bool ShowDetails)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("XpBarXpText_C", "SetDetailsVisibility");

	Params::XpBarXpText_C_SetDetailsVisibility Parms{};
