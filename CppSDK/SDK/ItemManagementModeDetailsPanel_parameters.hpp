...
// 0x0010 (0x0010 - 0x0000)
struct ItemManagementModeDetailsPanel_C_SetScrollFocusOnMulchDetailsPanel final
{
public:
	class UItemManagementMulchModeBox_C*          K2Node_DynamicCast_AsItem_Management_Mulch_Mode_Box; // 0x0000(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
