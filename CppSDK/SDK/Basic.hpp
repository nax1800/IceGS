...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05933660;
	constexpr int32 AppendString      = 0x018552B0;
	constexpr int32 GNames            = 0x0592F148;
	constexpr int32 GWorld            = 0x05A209E0;
	constexpr int32 ProcessEvent      = 0x01A040C0;
	constexpr int32 ProcessEventIdx   = 0x00000040;
    constexpr int32 Free              = 0x00000000;
    constexpr int32 Realloc           = 0x0178B010;
}
