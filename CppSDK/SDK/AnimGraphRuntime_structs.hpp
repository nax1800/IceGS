...
{
public:
	uint8                                         Pad_700[0x1C0];                                    // 0x0700(0x01C0)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
public:
	...
	uint8                                         Pad_246[0xCA];                                     // 0x0246(0x00CA)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
public:
	...
	uint8                                         Pad_1A[0xB6];                                      // 0x001A(0x00B6)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
public:
	...
	uint8                                         Pad_1B2[0x1];                                      // 0x01B2(0x0001)(Fixing Size After Last Property [ Dumper-8 ])
	uint8                                         bEnableWorldGeometry : 1;                          // 0x01B3(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideWorldGravity : 1;                         // 0x01B3(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTransferBoneVelocities : 1;                       // 0x01B3(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bFreezeIncomingPoseOnStart : 1;                    // 0x01B3(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1B4[0x38C];                                    // 0x01B4(0x038C)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
