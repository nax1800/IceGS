...
public:
	...
	struct FCollectionMissionBadgeDisplayInfo     CallFunc_Array_Get_Item;                           // 0x0028(0x0018)(NoDestructor, HasGetValueTypeHash)
...
struct CollectionMultiProgressBar_C_PlayFlashAnimation final
{
public:
