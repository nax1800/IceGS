...
// Function ItemManagementInventoryPanel.ItemManagementInventoryPanel_C.HandleFocusEquipSlotsBP
// (Event, Protected, BlueprintEvent)

void UItemManagementInventoryPanel_C::HandleFocusEquipSlotsBP()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementInventoryPanel_C", "HandleFocusEquipSlotsBP");

	UObject::ProcessEvent(Func, nullptr);
}


// Function ItemManagementInventoryPanel.ItemManagementInventoryPanel_C.BndEvt__HeaderTitle_K2Node_ComponentBoundEvent_0_BackButtonPressed__DelegateSignature
// (BlueprintEvent)

void UItemManagementInventoryPanel_C::BndEvt__HeaderTitle_K2Node_ComponentBoundEvent_0_BackButtonPressed__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementInventoryPanel_C", "BndEvt__HeaderTitle_K2Node_ComponentBoundEvent_0_BackButtonPressed__DelegateSignature");
...
void UItemManagementInventoryPanel_C::ProcessSlotAction(EFortItemTier RequestedTier)
{
	static class UFunction* Func = nullptr;
...
void UItemManagementInventoryPanel_C::UpdateHeaderShowTabs()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementInventoryPanel_C", "UpdateHeaderShowTabs");
