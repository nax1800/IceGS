...
public:
	...
	uint8                                         BitPad_188_6 : 2;                                  // 0x0188(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-8 ])
	...
	uint8                                         Pad_260[0x4];                                      // 0x0260(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_2AC[0x24];                                     // 0x02AC(0x0024)(Fixing Size After Last Property [ Dumper-8 ])
...
// 0x0738 (0x09A0 - 0x0268)
class UVehicleAnimInstance final : public UAnimInstance
{
public:
	uint8                                         Pad_268[0x728];                                    // 0x0268(0x0728)(Fixing Size After Last Property [ Dumper-8 ])
	class UWheeledVehicleMovementComponent*       WheeledVehicleMovementComponent;                   // 0x0990(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_998[0x8];                                      // 0x0998(0x0008)(Fixing Struct Size After Last Property [ Dumper-8 ])
