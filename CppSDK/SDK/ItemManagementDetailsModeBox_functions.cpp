...
void UItemManagementDetailsModeBox_C::MulchQuestComplete(bool* QuestComplete)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "MulchQuestComplete");

	Params::ItemManagementDetailsModeBox_C_MulchQuestComplete Parms{};
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UFortItemManagementViewPopup_C**  AsFort_Item_Management_View_Popup                      (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UItemManagementDetailsModeBox_C::GetItemManagementViewPopup(class UFortItemManagementViewPopup_C** AsFort_Item_Management_View_Popup)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "GetItemManagementViewPopup");

	Params::ItemManagementDetailsModeBox_C_GetItemManagementViewPopup Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (AsFort_Item_Management_View_Popup != nullptr)
		*AsFort_Item_Management_View_Popup = Parms.AsFort_Item_Management_View_Popup;
}
...
void UItemManagementDetailsModeBox_C::HandleCraftingOptions(bool* PassThrough)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "HandleCraftingOptions");

	Params::ItemManagementDetailsModeBox_C_HandleCraftingOptions Parms{};
