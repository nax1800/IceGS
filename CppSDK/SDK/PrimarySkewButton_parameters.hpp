...
public:
	...
	struct FSlateFontInfo                         K2Node_Select_Default;                             // 0x00B0(0x0050)(HasGetValueTypeHash)
	...
	float                                         CallFunc_GetStartTime_ReturnValue1;                // 0x0108(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetEndTime_ReturnValue1;                  // 0x010C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_PauseAnimation_ReturnValue;               // 0x0110(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_PauseAnimation_ReturnValue1;              // 0x0114(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_LessEqual_FloatFloat_ReturnValue1;        // 0x0134(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                         CallFunc_PauseAnimation_ReturnValue3;              // 0x0144(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   K2Node_Select3_Default;                            // 0x0188(0x0018)()
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue4;               // 0x01A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
