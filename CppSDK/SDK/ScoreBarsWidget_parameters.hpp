...
public:
	...
	bool                                          CallFunc_HasValidBadgeInfos_bHasValidBadgeInfos;   // 0x0014(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TDelegate<void(class AFortMissionState* MissionState)> K2Node_CreateDelegate_OutputDelegate1;    // 0x0024(0x0010)(ZeroConstructor, NoDestructor)
};
...
public:
	...
	TDelegate<void(class AFortMissionState* MissionState)> K2Node_CreateDelegate_OutputDelegate;     // 0x000C(0x0010)(ZeroConstructor, NoDestructor)
	int32                                         Temp_int_Loop_Counter_Variable;                    // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)(Fixing Size After Last Property [ Dumper-8 ])
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class AFortMission*>                   CallFunc_GetAllLoadedMissions_ReturnValue;         // 0x0028(0x0010)(ZeroConstructor, ReferenceParm)
	...
	class AFortMission*                           CallFunc_Array_Get_Item;                           // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	EStatCategory                                 Temp_byte_Variable;                                // 0x002C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UScoreMessageNumber_C*                  K2Node_Select_Default;                             // 0x0038(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortUIMessageItemWidget*               CallFunc_AddMessageItem_ReturnValue;               // 0x0040(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UScoreBarsScoreMessageItem_C*           K2Node_DynamicCast_AsScore_Bars_Score_Message_Item; // 0x0048(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	TDelegate<void(class UFortUIMessageItemWidget* MessageItem)> K2Node_CreateDelegate_OutputDelegate; // 0x0004(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(class UFortUIMessageItemWidget* MessageItem)> K2Node_CreateDelegate_OutputDelegate1; // 0x0014(0x0010)(ZeroConstructor, NoDestructor)
...
public:
	...
	TDelegate<void(EStatCategory ChangedScoreCategory)> K2Node_CreateDelegate_OutputDelegate1;       // 0x001C(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(EStatCategory ChangedScoreCategory)> K2Node_CreateDelegate_OutputDelegate2;       // 0x002C(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(EStatCategory ChangedScoreCategory)> K2Node_CreateDelegate_OutputDelegate3;       // 0x003C(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(int32 StatDelta, const class FText& StatName, EFortReplicatedStat StatType, EStatCategory StatCategory)> K2Node_CreateDelegate_OutputDelegate4; // 0x004C(0x0010)(ZeroConstructor, NoDestructor)
};
