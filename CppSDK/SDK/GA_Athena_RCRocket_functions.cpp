...
void UGA_Athena_RCRocket_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_RCRocket_C", "K2_OnEndAbility");

	Params::GA_Athena_RCRocket_C_K2_OnEndAbility Parms{};
...
void UGA_Athena_RCRocket_C::Update_Ignore_Move_and_Turn_Input(class AController* InController, bool Ignore)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_RCRocket_C", "Update Ignore Move and Turn Input");

	Params::GA_Athena_RCRocket_C_Update_Ignore_Move_and_Turn_Input Parms{};
...
// Parameters:
// struct FTransform*                      Transform_0                                            (Parm, OutParm, IsPlainOldData, NoDestructor)

void UGA_Athena_RCRocket_C::CalculateRocketSpawnLocation(struct FTransform* Transform_0) const
{
	static class UFunction* Func = nullptr;
	...
	if (Transform_0 != nullptr)
		*Transform_0 = std::move(Parms.Transform_0);
}
