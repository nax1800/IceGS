...
// Function PlayerPawn_Athena.PlayerPawn_Athena_C.BindToCalendarEvents
// (BlueprintCallable, BlueprintEvent)

void APlayerPawn_Athena_C::BindToCalendarEvents()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerPawn_Athena_C", "BindToCalendarEvents");
