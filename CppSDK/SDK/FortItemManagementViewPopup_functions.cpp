...
void UFortItemManagementViewPopup_C::BndEvt__MarkAllSeenButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortItemManagementViewPopup_C", "BndEvt__MarkAllSeenButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");

	Params::FortItemManagementViewPopup_C_BndEvt__MarkAllSeenButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature Parms{};
...
void UFortItemManagementViewPopup_C::SetupCBVisibility()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortItemManagementViewPopup_C", "SetupCBVisibility");
