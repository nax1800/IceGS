...
{
public:
	TDelegate<void(class UFortUIManagerWidget_NUI* Source, const struct FFortDialogDescription_NUI& DialogDescription)> K2Node_CreateDelegate_OutputDelegate; // 0x0000(0x0010)(ZeroConstructor, NoDestructor)
