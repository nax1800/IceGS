...
// Function ItemManagementItemTilePopupMenu.ItemManagementItemTilePopupMenu_C.WidgetAnimationEvt_FadeIn_K2Node_WidgetAnimationEvent_0
// (BlueprintEvent)

void UItemManagementItemTilePopupMenu_C::WidgetAnimationEvt_FadeIn_K2Node_WidgetAnimationEvent_0()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementItemTilePopupMenu_C", "WidgetAnimationEvt_FadeIn_K2Node_WidgetAnimationEvent_0");
...
void UItemManagementItemTilePopupMenu_C::CheckLevelUpQuestStatus(bool* RelevantQuestFound)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementItemTilePopupMenu_C", "CheckLevelUpQuestStatus");

	Params::ItemManagementItemTilePopupMenu_C_CheckLevelUpQuestStatus Parms{};
