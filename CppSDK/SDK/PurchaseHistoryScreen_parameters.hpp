...
public:
	...
	struct FMtxPurchaseHistory                    K2Node_Event_PurchaseHistory;                      // 0x0018(0x0018)()
	...
	EPurchaseReturnStep                           K2Node_Event_CurrentStep;                          // 0x0049(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         K2Node_Event_NumTicketsAvailableToUse;             // 0x0170(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UCommonTextBlock*>               K2Node_Event_ItemsToReturn;                        // 0x0180(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
	class UCommonTextBlock*                       CallFunc_Array_Get_Item;                           // 0x0190(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FSlateFontInfo                         K2Node_MakeStruct_SlateFontInfo;                   // 0x01A0(0x0050)(HasGetValueTypeHash)
	...
	class UFortUINavigationManager*               CallFunc_GetUINavigationManager_ReturnValue;       // 0x0200(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	bool                                          CallFunc_HasInputActionHandler_ReturnValue;        // 0x0015(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_HasInputActionHandler_ReturnValue1;       // 0x0016(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
