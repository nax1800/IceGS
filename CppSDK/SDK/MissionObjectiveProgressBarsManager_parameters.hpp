...
public:
	...
	TDelegate<void(const class AFortObjectiveBase* Objective, bool bNewVisibility)> K2Node_CreateDelegate_OutputDelegate1; // 0x001C(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(const class AFortObjectiveBase* Objective, EFortObjectiveStatus NewStatus)> K2Node_CreateDelegate_OutputDelegate2; // 0x002C(0x0010)(ZeroConstructor, NoDestructor)
};
