...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Athena_Instance_PlaysetGrenadeWithTrajectory_C; // 0x0C58(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UFortPlaysetItemDefinition*             PlaysetData;                                       // 0x0C60(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
