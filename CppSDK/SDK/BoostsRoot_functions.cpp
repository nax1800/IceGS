...
// Function BoostsRoot.BoostsRoot_C.BndEvt__HeaderWithNav_K2Node_ComponentBoundEvent_0_BackButtonPressed__DelegateSignature
// (BlueprintEvent)

void UBoostsRoot_C::BndEvt__HeaderWithNav_K2Node_ComponentBoundEvent_0_BackButtonPressed__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BoostsRoot_C", "BndEvt__HeaderWithNav_K2Node_ComponentBoundEvent_0_BackButtonPressed__DelegateSignature");

	UObject::ProcessEvent(Func, nullptr);
}


// Function BoostsRoot.BoostsRoot_C.OnBeginIntro
// (Event, Public, BlueprintEvent)

void UBoostsRoot_C::OnBeginIntro()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BoostsRoot_C", "OnBeginIntro");
...
void UBoostsRoot_C::SetupCenterWidget()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BoostsRoot_C", "SetupCenterWidget");
