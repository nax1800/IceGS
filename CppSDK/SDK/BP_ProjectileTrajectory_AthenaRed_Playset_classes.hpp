...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_ProjectileTrajectory_AthenaRed_Playset_C; // 0x0400(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UAudioComponent*                        Creative_Grenade_LoopRed_Cue;                      // 0x0408(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
