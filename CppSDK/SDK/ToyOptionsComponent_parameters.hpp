...
public:
	...
	class UCreativeSettingsPanel_C*               K2Node_DynamicCast_AsCreative_Settings_Panel;      // 0x0070(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
